...
public:
    ...
    DiffDriverController(double max_speed_,std::string cmd_topic_,StatusPublisher* hg_status_,CallbackAsyncSerial* cmd_serial_car_,CallbackAsyncSerial* cmd_serial_imu_,double r_min);
    void run();
